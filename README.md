...
This debate came up because Ethereum used to use **Proof of Work** until 2022. The NFTs generated by this tool are on **Polygon**, an environmentally friendly and inexpensive Ethereum sidechain.
...
3. Metamask will usually choose the correct gas price. However, it's possible that if there is a surge of activity right before you mint, your transactions may take a while to go through. You can wait or click 'speed up.' 
